...
# plot(douglasPeucker(A1,max),col="red",lwd=3)
```
...
# get the maximum distance
# plot(speedFilter(A1,0.01),col="red",lwd=3)
```
...
# plot(owMeratniaByCollection(tracksCollection,13804.84 ,
# 0.03182201))
